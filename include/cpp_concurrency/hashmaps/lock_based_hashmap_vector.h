...
#ifndef CPP_CONCURRENCY_LOCK_BASED_HASHMAP_VECTOR_H
#define CPP_CONCURRENCY_LOCK_BASED_HASHMAP_VECTOR_H
...
class lock_based_hashmap_vector {
private:
    class bucket_type {
        using bucket_value = std::pair<Key, Value>;
        using bucket = std::vector<bucket_value>;
...
public:
    explicit lock_based_hashmap_vector(std::size_t bucket_count = 19, const Hash& hash_function = Hash()):
    ...
    lock_based_hashmap_vector(const lock_based_hashmap_vector&) = delete;
    lock_based_hashmap_vector& operator=(const lock_based_hashmap_vector&) = delete;
...
#endif //CPP_CONCURRENCY_LOCK_BASED_HASHMAP_VECTOR_H
